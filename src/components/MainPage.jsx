...
const MainPage = () => {
  ...
  const filteredProjects = sortedProjects.filter((project) => {
    const matchesSearch =
      ...
      (project.subtitle &&
        project.subtitle.toLowerCase().includes(searchKeyword.toLowerCase())) ||
      (project.location &&
        project.location.toLowerCase().includes(searchKeyword.toLowerCase()));

    if (sortCriterion === "academic") {
      return (
        matchesSearch && project.category?.toLowerCase().includes("academic")
      );
    } else if (sortCriterion === "product") {
      return (
        matchesSearch && project.category?.toLowerCase().includes("product")
      );
    }
              ...
              <div className="row mt-4 d-flex align-items-stretch">
                <div className="col-md-4 h-100 mb-4 mb-md-0">
                  ...
                  >
                    <li>
                      <a
                        href="mailto:yudainakamura@keio.jp"
                        style={{
                          color: "#D44638",
                          textDecoration: "none",
                          display: "flex",
                    ...
                    <li>
                      <a
                        href="https://github.com/kamekingdom"
                        target="_blank"
                    ...
                    <li>
                      <a
                        href="https://www.linkedin.com/in/yudai-nakamura-kamekingdom/"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{
                          color: "#0a66c2",
